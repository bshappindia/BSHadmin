      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Un-Verified advertisments</a>
          </div>
            ...
            success:function(data){
                ...
                str += `<div class="col-md-4" id = "${data[index]['id'] + "_rootElement"}" style="background-color:white;">
                        <div class="card card-chart">
                            ...
                            <div class="card-body">
                            <h4 class="card-title">${data[index].companyName} </h4>
                            <p class="card-category">
                            ...
                            <p class="card-category">
                                website : ${data[index].websiteLink}
                            </p>
                            </div>
                            <div class="card-footer">
                            <button type="button" class="btn btn-primary verifyButton" oid="${data[index]['id']}" t = "adds" >Verify add</button>
                            <button type="button" class="btn btn-secondary deleteButton" oid="${data[index]['id']}" t = "adds" >Delete</button>
                            </div>
                        </div>
                        </div>`;
