...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Un-Verified News</a>
          </div>
  ...
  <script>
        ...
        for (let index = 0; index < data.length; index++) {
          str += `<div class="col-md-4" id = "${data[index]['id'] + "_rootElement"}" style="background-color:white;">
                  <div class="card card-chart">
                    ...
                    <div class="card-footer">
                      <button type="button" class="btn btn-primary verifyButton" oid="${data[index]['id']}" t = "news" >Verify</button>
                      <button type="button" class="btn btn-secondary deleteButton" oid="${data[index]['id']}" t = "news" >Delete</button>
                    </div>
                  </div>
                </div>`;
    ...
    xmlhttp.open("GET", "../mw1.php", false);
    xmlhttp.send();    
