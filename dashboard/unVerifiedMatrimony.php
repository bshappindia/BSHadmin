      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Un-Verified matrimony</a>
          </div>
...
<div class="modal" id="myModal">
  ...
  <script type="text/javascript">
    ...
    $.ajax({
            url : "../mw1.php?s=unVerifiedMatrimony",
            dataType:"JSON",
            type: "GET",
            async:false,
                ...
                str += `<div class="col-md-4" id = "${data[index]['id'] + "_rootElement"}">
                    <div class="card card-profile">
                      ...
                      <div class="card-body">
                        ...
                        <button  class="btn btn-primary btn-round showMore" oid = "${data[index]['id']}" verified = "false" >View more</button>
                        
                          <div class="card-footer">
                              <button type="button" class="btn btn-primary verifyButton" oid="${data[index]['id']}" t="matrimony" >Verify</button>
                              <button type="button" class="btn btn-secondary deleteButton" oid="${data[index]['id']}" t="matrimony" >Delete</button>
                          </div>
